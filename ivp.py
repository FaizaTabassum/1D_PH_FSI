...
def solve_ivp(fun,obj, t_span, y0, method='RK45', t_eval=None, dense_output=False,
    ...
    while status is None:
        ...
        if t_eval is None:
            ...
            if t_eval_step.size > 0:
                ...
                obj.evaluate_timepoint = True
                if obj.demo == True:
                    obj.dynamic_model(ts[-1], ys[-1])
    ...
    return OdeResult(t=ts, y=ys, sol=sol, t_events=t_events, y_events=y_events,requested_data = obj.requested_data,
