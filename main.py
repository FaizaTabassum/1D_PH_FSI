...
if __name__ == '__main__':
    ...
    pdic, internal_information_of_model, results_integration = func.run_simulation(loadrun.tube_base_radius, loadrun.tube_length, int(loadrun.number_sections), input_filename=loadrun.filename)
