...
def save_data(input_definition):
    ...
    save_data_dic = {'radius': input_definition.tube_base_radius, 'tube_base_radius': input_definition.tube_base_radius_val, 'tube_length': input_definition.tube_length,
                     'number_sections': input_definition.number_sections, 'proportion': input_definition.proportion, 'window': input_definition.window, 'start position': input_definition.position}
...
if __name__ == '__main__':
    ...
    plt.plot(np.linspace(0, parameter_dic['structure_length'], parameter_dic['N_sec']),
             parameter_dic['velocity'](parameter_dic['t_evaluation'][-1]))
    plt.show()
